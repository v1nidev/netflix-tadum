...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      this.$flickity.nextButton && this.$flickity.nextButton.element.setAttribute('alt', 'Próximo');
      this.$flickity.prevButton && this.$flickity.prevButton.element.setAttribute('alt', 'Anterior');
    },
