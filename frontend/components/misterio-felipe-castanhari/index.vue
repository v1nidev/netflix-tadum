<template>
  <main class="mistery">
    ...
    <section class="container">
      ...
      <p class="paragraph border-top has-text-centered m-b-16 p-t-8 is-size-7">
        Quem é aquela personagem que qndo aparece faz vc pensar “sou mto eu”?
      </p>

      <p class="paragraph m-t-4 m-t-48 is-size-7">
    ...
    <section class="container">
      ...
      <p class="paragraph border-top m-t-4 m-b-24 is-size-7">
    ...
    <section class="container">
      ...
      <p class="paragraph border-top m-t-4 is-size-7">
